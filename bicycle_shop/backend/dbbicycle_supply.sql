CREATE DATABASE  IF NOT EXISTS `dbbicycle_supply` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
INSERT INTO `attendance_details` VALUES (1,2,'07:45:00','12:00:00','Morning attendance'),(2,2,'12:45:00','17:00:00','Afternoon attendance');
...
INSERT INTO `employee` VALUES (1,'Dianna Claire Marie','Amihan','Cahayag','F','2004-12-16','dcmamihan','ndiw19Saq&','0006'),(2,'Elijah Raye Vel','Amihan','Cahayag','M','2004-10-22','ervamihan','cdj1248d','0004'),(3,'Brandon Boyd','Amihan','Cahayag','M','2004-01-17','bbamihan','fbeU3ennf','0003'),(4,'Ireneo','Palmero','Dizon','M','1978-03-15','ireneopalmero','bKeu^823','0001'),(5,'Angelo','Palen','Ramos','M','1992-07-22','angelopalen','checNNsw1','0001'),(6,'Menzi','Englatera','Reyes','F','1991-12-03','menzienglatera','cn!ejfiLIcbj','0001'),(7,'Raizel','Oppus','Soriano','F','1996-02-12','raizeloppus','ceb@4icjndso','0001'),(8,'Editha','Quezada','Villanueva','F','1983-06-25','ediquezada','vjijrfi(-+P','0001'),(9,'Geraldy','Toting','Mendoza','M','1979-08-08','gertoting','cvndjfc&%','0001'),(10,'Rustico','Bravo','Santos','M','1977-09-30','rusbravo','bvhfkca\"\'','0001'),(11,'Herald Vann','Alalim',NULL,'M','2004-04-23','hvalalim','feufh%\\\'nd','0002'),(12,'John Herbert','Yncierto',NULL,'M','2004-07-27','jhyncierto','cdf$5&6()','0007'),(13,'Jacqueline','Yncierto',NULL,'F','1981-12-03','jacyncierto','ncjd\"{nsq<>','0001'),(14,'Sherwin','Amihan','Balondo','F','1984-08-18','samihan','$2b$10$s0/9PN/xRcaiLfKWSEOTqe2DnBVmU9LHlrGqEmGz0..DWjh8WAhNe','0001');
...
INSERT INTO `employee_attendance` VALUES (1,1,'2025-02-25','1002'),(2,2,'2025-02-25','1001'),(3,3,'2025-02-25','1001'),(4,4,'2025-02-25','1001'),(5,5,'2025-02-25','1001'),(6,6,'2025-02-25','1001'),(7,7,'2025-02-25','1005'),(8,8,'2025-02-25','1001'),(9,9,'2025-02-25','1001'),(10,10,'2025-02-25','1002'),(11,11,'2025-02-25','1001'),(12,12,'2025-02-25','1001');
...
-- Dump completed on 2025-03-10 21:48:31
